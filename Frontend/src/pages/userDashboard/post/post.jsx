      ...
      <div className="create-post-container">
        ...
        <form onSubmit={handleSubmit} className="create-post-form">
          ...
          <input
            ...
            onChange={handleChange}
          />
          {previewImage && <img src={previewImage} alt="Vista previa" className="create-post-preview-image" />}
          <div className="create-post-actions">
            <button type="submit" className="create-post-btn publish">Publish</button>
            <button type="button" className="create-post-btn cancel" onClick={() => navigate('/inicio')}>Cancel</button>
          </div>
        </form>
      </div>
    </div>
